    ...
    <div className="w-full mx-auto rounded-lg bg-gray-800 shadow-lg px-5 pt-5 pb-10 transition ease-in-out hover:scale-105 transform -translate-y-2">
      ...
      <div className="w-full">
        <svg
          ...
          viewBox="0 0 48 48"
          className="relative top-0 left-0 transform translate-x-6 translate-y-6 h-12 w-12 fill-current text-white opacity-10"
        >
        ...
        <p className="text-md font-secondary text-gray-300 text-center px-5">
          {quote}
        </p>
        <svg
          xmlns="http://www.w3.org/2000/svg"

  ...
  return (
    <div className="overflow-hidden bg-gray-800 rounded-lg shadow-md items-center w-auto lg:w-4/6 mx-auto py-8 my-10">
      <div className="w-3/4 md:w-1/2 mx-auto">
        <h1 className="text-center font-primary font-black text-5xl capitalize text-gray-300 transition duration-500 ease-in-out transform hover:scale-105 hover:text-yellow-400">
          Let's Talk
        </h1>
